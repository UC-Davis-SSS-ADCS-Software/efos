...
def Main_ADCS(sunsensor_inputs, mag_inputs, angvel_inputs, epoch_time, mode, TLE1, TLE2, w_rw, delta_t):
    ...
    # If REALOP is already detumbled, check if in eclipse before attempting to calculate attitude
        ...
        try:
            ...
            sun_pos_eci = sunLookup(epoch_time)
            mag_vector_ecef = igrf_mag_vector_ecef(pos_ecef, epoch_time)
            ...
            w_body = body_angvel[2] # MOI of body about z-axis
