...
R_SENSOR_TO_BODY = np.array(((np.cos(THETA_IMU), -np.sin(THETA_IMU), 0), (np.sin(THETA_IMU), np.cos(THETA_IMU), 0), (0, 0, 1))) # Rotation matrix to aign IMU and Satellite Axes
