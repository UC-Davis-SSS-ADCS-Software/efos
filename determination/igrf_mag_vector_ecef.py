...
def igrf_mag_vector_ecef(x_ecef, t_jd):
    ...
    xq = u.quantity.Quantity(x_ecef[1], u.km)
    yq = u.quantity.Quantity(x_ecef[2], u.km)
    z1 = u.quanity.Quantity(x_ecef[3], u.km)
    loc = EarthLocation(xq,yq,zq)
    ...
    alt = altitude.value / 1000 # altitude in km
